...
<script src="<?php echo HOME_URL;?>/js/jssor.slider.min.js"></script>
  <script defer src="<?php echo HOME_URL;?>/js/jquery.flexslider.js"></script>
...
if(x0!=xf){setTimeout("moveGB("+x+", "+xf+")", 10);}
 ...
 //          $('.menutrentopright ul li').css('-webkit-transition','all 0.4s ')
 //         $('.menutrentopleft ul li').css('-webkit-transition','all 0.4s ')
