...
if(!$OK) product("?".TTH_PATH."=product_add", "add", 0, $product_menu_id, $name, $img, $img_note, $product_keys, $price, $model, $sale,$train, $comment, $content, $upload_img_id, $is_active, $hot, $pin, $created_time, $title, $description, $keywords, $error);
?>